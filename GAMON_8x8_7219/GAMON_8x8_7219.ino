...
const byte cp437_font [256] [8] PROGMEM = {
  ...
  { 0xff,0xc1,0xa1,0x91,0x91,0xa1,0xc1,0xff}, // 0xFF
};  //  end of cp437_font
...
void setup ()
{
  ...
  sendByte (MAX7219_REG_INTENSITY, 0);  // character intensity: range: 0 to 15
...
{ 
 ...
 //showString("Pappa Ruler !", 500);
 
  //letter(c);
  //c++;
  
  /*for(omat = 1; omat < 8; omat++){
    c++;
    sendByte(omat,c);
  }*/
