...
const char* tempTopic =		"sbv9/mekkepult/temperatur";			//## Topic to post temperature
const char* humTopic =		"sbv9/mekkepult/fuktighet";			//## Topic to post Humidity
const char* btnTopic =		"sbv9/mekkepult4/port_bryter";			//## Topic to post buttonstate
const char*	clientName =	"ESP_Mekkepult";						//## Client name. unike
